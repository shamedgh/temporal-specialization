...
get_blocked_payloads("removedViaLibSpecialization.txt","resultViaLibSpecializationROP.txt")
...
get_blocked_payloads(args.blockedSyscallFile,"resultViaTemporalDebloatingROP.txt")
